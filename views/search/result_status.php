...
function partialResultsStatus($searchBuilder, $searchView)
{
    ...
    <div class="pull-left">
        <div class="dropdown">
            <button class="btn btn-default btn-xs dropdown-toggle" type="button" id="dropdown-sort" data-toggle="dropdown" aria-label="button for selecting number of results per page">
...
function partialResultsStatus_down($searchBuilder, $searchView)
{
    $rowNum = array("5", "10", "20", "50", "100");
    $rows_per_page = $searchBuilder->getRowsPerPage();
    $selected_total_rows = $searchBuilder->getSelectedTotalRows();
    ...
    <div class="pull-left">
        <div class="dropdown">
            <button class="btn btn-default btn-xs dropdown-toggle" type="button" id="down_dropdown-sort" data-toggle="dropdown" aria-label="button for selecting number of results per page at downpage">
                <?php echo $rows_per_page ?> Per Page
                <span class="caret"></span>
            </button>
            <ul class="dropdown-menu">
